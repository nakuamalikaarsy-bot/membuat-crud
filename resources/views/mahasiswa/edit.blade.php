...
<body>
    ...
    <div class="container mt-4">
        <p class="fs-4">Edit Data Mahasiswa</p>
        ...
        <form method="POST" action="/mahasiswa/update/{{ $mahasiswa->id }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('program_studi') is-invalid @enderror" id="program_studi" name="program_studi" value="{{ old('program_studi', $mahasiswa->program_studi) }}">
